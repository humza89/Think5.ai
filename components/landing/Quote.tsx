      ...
      <Container>
        <Reveal className="mx-auto max-w-4xl border-y border-ink/15 py-16 text-center md:py-24">
          ...
          <blockquote className="mt-6 font-display text-[30px] leading-[1.15] tracking-[-0.01em] text-ink md:text-[44px]">
            Think5 has transformed how we build our AI teams. The quality of candidates and the speed of placement
            exceeded all our expectations.
          </blockquote>
          <figcaption className="mt-8 text-[14px] text-graphite">
            <span className="font-medium text-ink">Sarah Chen</span> · VP of Engineering, frontier AI lab
          </figcaption>
        </Reveal>
      </Container>
    </section>
