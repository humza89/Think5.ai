      ...
      <aside className="w-48 bg-white border-r border-gray-200 flex flex-col">
        ...
        <nav className="flex-1 py-4">
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-2 text-sm rounded-lg mx-2 mb-1 ${
              activeTab === "overview"
          ...
          <Link
            href="/candidates"
            className="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded-lg mx-2 mb-1"
          >
            <Users className="w-4 h-4" />
            <span>Sourcing</span>
          </Link>

          <button className="w-full flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded-lg mx-2 mb-1">
