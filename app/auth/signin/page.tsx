    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link href="/auth/forgot-password" className="text-[13px] text-graphite underline-offset-4 transition-colors hover:text-ink hover:underline">
              Forgot password?
            </Link>
          </div>
      ...
      <div className="relative my-8">
        ...
        <div className="relative flex justify-center">
          <span className="bg-paper px-3 text-[12px] uppercase tracking-[0.16em] text-graphite">or</span>
        </div>
      </div>
      ...
      <p className="mt-10 border-t border-stone pt-6 text-center text-[14px] text-graphite">
        Don&apos;t have an account?{" "}
        <Link href="/auth/signup" className="font-medium text-ink underline-offset-4 hover:underline">
          Create one now
        </Link>
      </p>
    </AuthShell>
