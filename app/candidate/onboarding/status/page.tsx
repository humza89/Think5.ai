    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-lg">
        ...
        {state?.onboardingStatus === "REJECTED" && (
          <RejectedCard reason={state.rejectionReason} />
        )}

        {state?.onboardingStatus === "ON_HOLD" && (
          <OnHoldCard />
        )}
      ...
      <CardContent className="p-8">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-sm">
            Thank you for completing your profile! Our team is currently reviewing your
          ...
          <div className="w-full rounded-lg bg-muted/50 p-4 text-left">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-muted-foreground/40" />
                Once approved, you&apos;ll get access to AI interviews and job matches
              </li>
            </ul>
          </div>
        </div>
    ...
    <Card className="border-green-200/50 dark:border-green-800/30">
      <CardContent className="p-8">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-sm">
            Your profile has been reviewed and approved. You now have full access to
            the Think5 platform.
          </p>
      ...
      <CardContent className="p-8">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-muted-foreground mb-4 max-w-sm">
            After reviewing your profile, our team has identified some areas that
            need attention.
          </p>

          {reason && (
            <div className="w-full rounded-lg border border-amber-200/50 bg-amber-50 dark:border-amber-800/30 dark:bg-amber-900/10 p-4 mb-6 text-left">
          ...
          <p className="text-xs text-muted-foreground mt-4">
            Once updated, your profile will be automatically re-submitted for review.
          </p>
        </div>
      </CardContent>
    </Card>
      ...
      <CardContent className="p-8">
        <div className="flex flex-col items-center text-center">
          <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-orange-100 dark:bg-orange-900/30">
            <PauseCircle className="h-8 w-8 text-orange-600 dark:text-orange-400" />
          </div>
          ...
          <p className="text-muted-foreground mb-6 max-w-sm">
            Your profile is being reviewed by our team and requires additional time.
