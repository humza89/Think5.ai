  ...
  return (
    <>
      ...
      <div className="max-w-[1800px] mx-auto px-6 py-6">
        {/* Title */}
        <div className="mb-4">
          <h1 className="text-2xl font-semibold">Think5 Sourcing</h1>
          <p className="text-sm text-gray-600 mt-1">
            Source and submit candidates from our sourcing tool all within Think5.{" "}
        ...
        <div className="mb-3 flex items-center gap-2 flex-wrap">
          ...
          <div className="relative">
            <label htmlFor="candidates-search" className="sr-only">Search candidates</label>
